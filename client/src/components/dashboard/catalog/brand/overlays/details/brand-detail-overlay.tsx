      ...
      {isEditing ? (
        ...
        >
          <div className="flex items-center gap-3 mb-8">
            <div className="p-3 bg-primary/10 rounded-[var(--radius)] text-primary">
          ...
          <div className="bg-muted/5 border-[0.5px] border-border/40 p-4 rounded-[var(--radius)] mb-4">
            <BrandForm
        ...
        >
            ...
            <div className="flex flex-col md:flex-row md:items-start justify-between gap-6">
              ...
              <div className="flex gap-2 shrink-0">
                {[
                  ...
                  <div
                    key={i}
                    className="bg-muted/10 border border-border/10 px-3 py-2 rounded-[var(--radius)] min-w-[100px]"
                  >
          ...
          <div className="grid grid-cols-1 lg:grid-cols-5 gap-6">
            <section className="lg:col-span-3 bg-muted/5 border-[0.5px] border-border/40 rounded-[var(--radius)] p-5 relative overflow-hidden flex items-center justify-between">
              ...
              <Button
                ...
                className="relative z-10 rounded-[var(--radius)] px-4 h-9 shadow-none font-bold uppercase tracking-wide text-[9px]"
              >
            ...
            <section className="lg:col-span-2">
              ...
              <div className="flex flex-wrap gap-1.5">
                {['High Quality', 'Eco', 'Global', 'Best Seller'].map((tag) => (
                  <span
                    key={tag}
                    className="px-3 py-1 rounded-[var(--radius)] bg-background border border-border/10 text-[9px] font-bold uppercase tracking-tight"
                  >
                    {tag}
                  </span>
                ))}
          ...
          <section className="pt-6 border-t border-border/40">
            <div className="bg-danger-soft/5 border-[0.5px] border-danger-soft/20 rounded-[var(--radius)] p-4 flex items-center justify-between gap-4">
              <div className="flex items-center gap-4">
                <div className="p-2 rounded-[var(--radius)] bg-danger-soft/10 text-danger-soft">
                  <AlertTriangle className="h-4 w-4" />
                </div>
                <div>
                  <h4 className="text-xs font-bold uppercase text-danger-soft">
                    Xóa thương hiệu
                  </h4>
              ...
              <Button
                ...
                className="border-danger-soft/20 text-danger-soft hover:bg-danger-soft hover:text-white rounded-[var(--radius)] px-4 h-8 text-[9px] font-bold uppercase tracking-widest"
              >
                Xóa ngay
              </Button>
            </div>
