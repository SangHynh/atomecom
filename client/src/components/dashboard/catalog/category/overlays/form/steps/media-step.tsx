      ...
      <div className="grid grid-cols-1 sm:grid-cols-4 gap-12">
        <div className="sm:col-span-1 space-y-4">
          ...
          <FormField
            ...
            name="image"
            render={({ field }) => (
              <div className="group relative aspect-square rounded-[var(--radius)] border border-border/10 overflow-hidden bg-muted/5 flex items-center justify-center transition-all cursor-crosshair hover:border-primary/20 shadow-none">
                {field.value ? (
                  <>
                    <img
                      src={field.value}
                    ...
                    <div className="absolute inset-0 bg-background/80 backdrop-blur-md opacity-0 group-hover:opacity-100 transition-all flex flex-col items-center justify-center p-4 gap-3">
                      <Button
                        ...
                        type="button"
                        className="h-8 px-3 rounded-[var(--radius)] border border-border/10 font-bold text-[8px] uppercase tracking-wider text-muted-foreground/60"
                      >
                        Gỡ ảnh
                      </Button>
                    </div>
              ...
              <FormItem>
                ...
                <FormControl>
                  <Textarea
                    ...
                    className="border border-border/10 rounded-[var(--radius)] bg-muted/5 p-4 text-xs leading-relaxed resize-none shadow-none focus-visible:ring-0 focus-visible:border-primary/30 transition-all font-medium italic h-[160px]"
                  />
                </FormControl>
              </FormItem>
            )}
