        ...
        <FormField
          ...
          render={({ field }) => (
            <FormItem>
              ...
              >
                <FormControl>
                  <SelectTrigger className="h-11 border border-border/60 rounded-[var(--radius)] bg-muted/5 px-4 font-semibold text-sm shadow-none focus:ring-0">
                    <SelectValue placeholder="Chọn danh mục cha" />
                  </SelectTrigger>
                </FormControl>
                <SelectContent className="rounded-[var(--radius)] border-border/40 shadow-none">
                  <SelectItem
                    value="root"
          ...
          render={({ field }) => (
            <FormItem>
              ...
              <Select onValueChange={field.onChange} defaultValue={field.value}>
                <FormControl>
                  <SelectTrigger className="h-11 border border-border/60 rounded-[var(--radius)] bg-muted/5 px-4 font-bold text-[10px] uppercase tracking-wide shadow-none focus:ring-0">
                    <SelectValue />
                  </SelectTrigger>
                </FormControl>
                <SelectContent className="rounded-[var(--radius)] border-border/40 shadow-none">
