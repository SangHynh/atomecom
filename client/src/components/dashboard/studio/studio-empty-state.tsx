...
export function StudioEmptyState({
  ...
  return (
    <div className="flex flex-col items-center justify-center py-20 px-6 text-center animate-in fade-in zoom-in-95 duration-700">
      <div className="h-20 w-20 bg-muted/5 rounded-sm flex items-center justify-center border border-border/10 mb-8 group-hover:scale-110 transition-transform">
