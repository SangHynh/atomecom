...
export function UserDetailSecurity({ user }: UserDetailSecurityProps) {
  ...
  return (
    <div className="space-y-3 pt-1">
      ...
      <div className="rounded-2xl border border-border/40 bg-background/60 overflow-hidden divide-y divide-border/20 ring-1 ring-border/10">
        <div className="flex items-center justify-between p-3">
          ...
          {user.isOnline ? (
            ...
            <Badge
              variant="outline"
              className="text-[10px] font-black px-1.5 py-0 border-border/50 opacity-70"
            >
              OFFLINE
            </Badge>
          )}
