  ...
  return (
    <section id="solutions" className="py-24 sm:py-32 relative">
      <div className="container mx-auto max-w-7xl px-6 lg:px-20">
        ...
        >
          <h3 className="mb-4 text-2xl sm:text-4xl lg:text-5xl font-bold tracking-tight text-foreground font-heading">
            ...
            >
              <Card className="group relative h-full overflow-hidden border border-border/50 bg-background/50 backdrop-blur-md shadow-sm transition-all duration-700 hover:shadow-2xl hover:shadow-primary/10 hover:border-primary/40 rounded-[1.5rem] sm:rounded-[2rem] cursor-pointer hover:-translate-y-2 sm:hover:-translate-y-4">
                <CardHeader className="pt-8 sm:pt-10 pb-4 relative z-10">
                  <div
                    className={`mb-4 sm:mb-6 flex h-12 sm:h-14 w-12 sm:w-14 items-center justify-center rounded-xl sm:rounded-2xl bg-muted transition-all duration-700 group-hover:bg-primary/10 ${solution.color} group-hover:scale-125 group-hover:rotate-[10deg] group-hover:shadow-xl group-hover:shadow-primary/5`}
                  >
                    {solution.icon}
                  </div>
                  <CardTitle className="text-lg sm:text-xl font-bold tracking-tight transition-colors duration-700 group-hover:text-primary">
                    {solution.title}
                  </CardTitle>
                </CardHeader>
