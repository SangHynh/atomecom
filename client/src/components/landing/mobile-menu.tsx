            ...
            >
              ...
              <div className="mt-12 pt-8 border-t border-border/40 space-y-4">
                ...
                <NextLink href="/login" onClick={toggleMenu} className="block">
                  <Button variant="outline" className="w-full justify-start h-12 rounded-xl border-border/40 font-bold">
                    {t('nav.login')}
                  </Button>
                </NextLink>
                <NextLink href="/register" onClick={toggleMenu} className="block">
