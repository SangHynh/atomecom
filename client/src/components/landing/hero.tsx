        ...
        >
          ...
          >
            {[
              ...
              <div
                key={idx}
                className="flex items-center gap-2 transition-all hover:opacity-100 group cursor-default py-1"
              >
                <div
                  className={`transition-all duration-500 group-hover:scale-150 group-hover:rotate-12 ${item.color}`}
                >
                  {item.icon}
                </div>
                <span className="text-[9px] sm:text-[10px] font-bold uppercase tracking-widest text-muted-foreground group-hover:text-foreground transition-all duration-500 group-hover:tracking-[0.2em]">
                  {item.label}
                </span>
              </div>
            ))}
